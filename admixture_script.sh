...
run=$(( run + 1 ));
for K in 2 3 4 5  ; do # select a meaningful series of K. The more Ks, the longer the run it takes. #-jX:computation on X threads. #-s time:random seed to be generated from the current time
